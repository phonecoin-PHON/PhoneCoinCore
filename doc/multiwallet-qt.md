...
In order to support loading of multiple wallets in phonecoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is phonecoin.cpp.
...
Changes to phonecoin.cpp
----------------------
phonecoin.cpp is the entry point into phonecoin-qt, and as such, will require some minor modifications to provide hooks for
