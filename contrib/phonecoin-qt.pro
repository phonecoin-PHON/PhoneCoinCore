...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/phonecoin-cli.cpp \
           src/phonecoin-tx.cpp \
           src/phonecoin.cpp \
           src/db.cpp \
           ...
           src/qt/phonecoin.cpp \
           src/qt/phonecoinstrings.cpp \
...
RESOURCES += src/qt/phonecoin.qrc src/qt/phonecoin_locale.qrc

TRANSLATIONS += src/qt/locale/phonecoin_bg.ts \
                src/qt/locale/phonecoin_de.ts \
                src/qt/locale/phonecoin_en.ts \
                src/qt/locale/phonecoin_es.ts \
                src/qt/locale/phonecoin_fi.ts \
                src/qt/locale/phonecoin_fr.ts \
                src/qt/locale/phonecoin_it.ts \
                src/qt/locale/phonecoin_ja.ts \
                src/qt/locale/phonecoin_pl.ts \
                src/qt/locale/phonecoin_pt.ts \
                src/qt/locale/phonecoin_ru.ts \
                src/qt/locale/phonecoin_sk.ts \
                src/qt/locale/phonecoin_sv.ts \
                src/qt/locale/phonecoin_vi.ts \
                src/qt/locale/phonecoin_zh_CN.ts \
                src/qt/locale/phonecoin_zh_TW.ts
