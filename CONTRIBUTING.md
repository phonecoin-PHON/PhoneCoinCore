Contributing to PhoneCoin Core
============================

The PhoneCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the PhoneCoin Core project, and is not to be
confused with overall PhoneCoin Network Protocol consensus changes.

Whether a pull request is merged into PhoneCoin Core rests with the project merge
...
Patches that change PhoneCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the PhoneCoin consensus, it must have been
...
The project leader is the release manager for each PhoneCoin Core release.
