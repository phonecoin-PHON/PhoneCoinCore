...
#   c) node1 mines 32 blocks, so now node 0 has 60001phonecoin, node 1 has 4250phonecoin, node2 has none.
#   d) node0 sends 601 phonecoin to node2, in two transactions (301 phonecoin, then 300 phonecoin).
