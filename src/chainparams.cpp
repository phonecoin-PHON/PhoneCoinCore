...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("000002483b7867c7ec47c26f3b3dc95aefa844d864ea66a02f2fc1271c05b57a"))
    (155600, uint256("db4e592e8b7ce0fae4d4599418f1e0b33b41cd4b48ab1bb910ddef5f93bf8628"))
                              ;

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1546230417, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetSpacing = 1 * 60;  // PhoneCoin: 1 minute after 6000
        nTargetSpacingSlowLaunch = 5 * 60; // before block 6000
        // nAntiInstamineTime = 50; // 720 blocks with 1 reward for instamine prevention
        nMaturity = 167;
        nMasternodeCountDrift = 3;
        nMaxMoneyOut = 201000000 * COIN;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "the start of amazing phone coin";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1535812747;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1994789;
        ...
        strSporkKey = "033f069a906552224554c6613bf9897b8083f7194ae1058617c7ae1c6aee69509d";
        strObfuscationPoolDummyAddress = "pSDj2gC9j6nNrnzCsg4aY6bHMLsT9nUhEw";
        nStartMasternodePayments = 1535812747 + 150000; //after 1 day and 17h of genesis
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetSpacing = 1 * 60;  // PhoneCoin: 1 minute
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 137); // Testnet PhoneCoin addresses start with 'x'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet PhoneCoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet PhoneCoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet PhoneCoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet PhoneCoin BIP44 coin type is '1' (All coin's testnet default)
