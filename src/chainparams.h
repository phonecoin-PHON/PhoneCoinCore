 ...
 * PhoneCoin system. There are three: the main network on which people trade goods
...
public:
    ...
    // const std::vector<unsigned char>& PhoneCoinDevKey() const { return vPhoneCoinDevKey; }
    // const std::vector<unsigned char>& PhoneCoinFundKey() const { return vPhoneCoinFundKey; }
...
protected:
    ...
    // std::vector<unsigned char> vPhoneCoinDevKey;
    // std::vector<unsigned char> vPhoneCoinFundKey;
    // int nDevFee;
    // int nFundFee;
    int nDefaultPort;
