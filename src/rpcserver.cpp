...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "PhoneCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PhoneCoin features */
        {"phonecoin", "masternode", &masternode, true, true, false},
        {"phonecoin", "listmasternodes", &listmasternodes, true, true, false},
        {"phonecoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"phonecoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"phonecoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"phonecoin", "masternodedebug", &masternodedebug, true, true, false},
        {"phonecoin", "startmasternode", &startmasternode, true, true, false},
        {"phonecoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"phonecoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"phonecoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"phonecoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"phonecoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"phonecoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"phonecoin", "mnsync", &mnsync, true, true, false},
        {"phonecoin", "spork", &spork, true, true, false},
        {"phonecoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"phonecoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use phonecoind, or the -server option to phonecoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> phonecoin-cli " + methodname + " " + args + "\n";
}
