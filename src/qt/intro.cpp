...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("PhoneCoin Core"),
     ...
     * override -datadir in the phonecoin.conf file in the default data directory
     * (to be consistent with phonecoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
