...
QFontDatabase::addApplicationFont(":/fonts/phonecoin_font");

QString windowTitle = tr("PhoneCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PhoneCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and PhoneCoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PhoneCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about PhoneCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PhoneCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PhoneCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PhoneCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a PhoneCoin: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the PhoneCoin Core help message to get a list with possible PhoneCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("PhoneCoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("PhoneCoin Core"); // default title
