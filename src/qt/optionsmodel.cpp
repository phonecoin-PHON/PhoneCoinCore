...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::PHON);
...
// Wallet
    ...
    if (settings.contains("nAnonymizePhcAmount"))
        SoftSetArg("-anonymizephonecoinamount", settings.value("nAnonymizePhcAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in phonecoin.cpp during shotdown to also remove the window positions
