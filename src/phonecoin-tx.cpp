...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("PhoneCoin Core phonecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  phonecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded PhoneCoin transaction") + "\n" +
                               "  phonecoin-tx [options] -create [commands]   " + _("Create hex-encoded PhoneCoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded PhoneCoin transaction
