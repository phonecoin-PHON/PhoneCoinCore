/* src/config/phonecoin-config.h.  Generated from phonecoin-config.h.in by configure.  */
/* src/config/phonecoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef PhoneCoin_CONFIG_H

#define PhoneCoin_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.phonecoin.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "PhoneCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "PhoneCoin Core 1.0.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "phonecoin"
